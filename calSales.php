...
if(isset($_POST['submit']))
{
    ...
    $sql = "INSERT INTO `product_sales`(`sales`, `date`) 
    VALUES ('$sales','$date')";
    ...
    if($result)
    {
        header("Location: viewsales.php?msg=New record created successfully");
    }
    else
    {
        echo "Failed: ";
...
<body>
    ...
    <div class="container">
        ...
        <div class="container d-flex justify-content-center">
            <form action="calSales.php" method="post" style="width:50vm; min-width:300px;">
                <div class="row">
